                ...
                do
                {
                    ...
                    if (sectorChoice == 1)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                portfolio2.cashLeftover += portfolio2.getChosenDivisions()[0].getInstruments()[sectorChoice - 1].getProfitLoss();
                ...
                do
                {
                    ...
                    if (sectorChoice == 1)
                    {
                        ...
                        else
                        {
                            ...
                            {
                                portfolio3.cashLeftover += portfolio3.getChosenDivisions()[0].getInstruments()[sectorChoice - 1].getProfitLoss();
