...
public class Main {
    ...
    private static void createPortfolio(){
        ...
        if(numPortfolios == 1){
            ...
            for(int i = 0; i < portfolio2.chosenDivisions.length; i++){

                for(int u = 0; u < portfolio2.chosenDivisions[i].instruments.length; u++){
                    portfolio2.chosenDivisions[i].instruments[u].buyShares();
